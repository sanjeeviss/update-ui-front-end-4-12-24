...
export default function HomePage2() {
    ...
    const cardItems = [
        { text: "DashBoard", icon: <DashboardIcon /> ,onclick : () => navigate('/EmployeeDashBoard2')  },
        { text: "Settings", icon: <SettingsIcon /> },
        { text: "Attendance", icon: <TodayIcon />, onclick : () => navigate('/BasicDateCalendar2') },
        { text: "Leave", icon: <AssignmentIcon /> },
        { text: "Shift", icon: <AccessTimeIcon /> },
        { text: "Payslip", icon: <ReceiptIcon /> },
        { text: "Reimbursement", icon: <CurrencyExchangeIcon />, onclick : () => navigate('/ReimbursementForm2') }, 
